...
namespace VncViewer.Vnc
{
    public class VncClient : IDisposable
    {
        ...
        public void Connect(string host, int port = 5900)
        {
            ...
            tcpClient.Connect(host, port); /*System.Net.Internals.SocketExceptionFactory.ExtendedSocketException:
                                            *'An attempt was made to access a socket in a way forbidden by its access permissions 10.42.1.147:5900*/
